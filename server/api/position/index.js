...
router.put('/:id', auth.hasPermissionToAddEntity(), controller.upsert);
router.patch('/:id', auth.hasPermissionToAddEntity(), controller.patch);
router.delete('/:id', auth.hasPermissionToAddEntity(), controller.destroy);

module.exports = router;
//# sourceMappingURL=../../api/position/index.js.map